  ...
  return (
    <div className="noise bg-bg text-primary min-h-screen">
      ...
      <div className="fixed top-6 left-0 right-0 z-50 flex justify-center pointer-events-none">
        ...
        <div
          className="pointer-events-auto rounded-full p-px shadow-2xl"
          style={{
        ...
        >
          <nav className="flex items-center gap-1 px-1 py-1 rounded-full"
            style={{ background: 'rgba(14,14,18,0.84)', backdropFilter: 'blur(24px) saturate(160%)' }}
          >
            <a
              href="#home"
              className="text-primary font-semibold text-[0.83rem] tracking-tight px-4 py-[0.42rem] rounded-full mr-1 transition-all duration-200 whitespace-nowrap"
              style={{
                background: 'linear-gradient(135deg, rgba(255,255,255,0.09), rgba(255,255,255,0.04))',
                border: '1px solid rgba(255,255,255,0.08)',
              }}
            >
              Prakash <span className="text-muted font-normal">Shukla</span>
            </a>
            <span className="w-[3px] h-[3px] rounded-full mx-1 flex-shrink-0 bg-white/15" />
            <ul className="flex list-none gap-0">
              {['About','Experience','Projects','Skills'].map(item => (
                <li key={item}>
                  <a
                    href={`#${item.toLowerCase()}`}
                    className="nav-link-item block text-[0.76rem] text-muted hover:text-primary px-[0.9rem] py-[0.42rem] rounded-full transition-colors duration-200 hover:bg-white/[0.06] whitespace-nowrap"
                  >
                    {item}
                  </a>
                </li>
              ...
              <li>
                <a
                  href="#contact"
                  className="block text-[0.76rem] font-medium text-primary px-[0.9rem] py-[0.42rem] rounded-full ml-1 transition-all duration-200 whitespace-nowrap hover:bg-white/20"
                  style={{
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute -top-24 -right-24 w-[500px] h-[500px] rounded-full opacity-[0.18] pointer-events-none -z-10"
          style={{ background: 'radial-gradient(circle, #4a9d6e, transparent)', filter: 'blur(120px)' }} />
        <div className="absolute bottom-0 -left-12 w-[400px] h-[400px] rounded-full opacity-[0.18] pointer-events-none -z-10"
          style={{ background: 'radial-gradient(circle, #3a5fa0, transparent)', filter: 'blur(120px)' }} />

        <section id="home" className="relative min-h-screen flex flex-col justify-center px-10 max-w-[860px] mx-auto">
          ...
          <p className="text-secondary text-base max-w-[480px] leading-relaxed mb-10">
          ...
          <div className="flex items-center gap-4 flex-wrap">
            <a href="#projects"
              className="text-[0.82rem] font-medium bg-primary text-bg px-6 py-[0.65rem] rounded-lg transition-opacity hover:opacity-85 tracking-tight">
              View Projects
            </a>
            <a href="https://github.com/PrakashShukla0907" target="_blank" rel="noreferrer"
              className="text-[0.82rem] text-secondary border border-white/10 px-6 py-[0.65rem] rounded-lg transition-all hover:border-white/25 hover:text-primary">
              GitHub ↗
            </a>
          </div>

          <p className="scroll-line absolute bottom-10 left-10 text-[0.72rem] text-muted tracking-[0.08em] flex items-center gap-2">
            Scroll
          </p>
        </section>
      </div>
      ...
      <div className="max-w-[860px] mx-auto px-10">
        ...
        <section id="about" className="py-20 border-t border-white/[0.07]">
          <h2 className="text-[1.6rem] font-semibold tracking-[-0.03em] mb-12">About</h2>
          <div className="grid grid-cols-2 gap-16 items-start">
            <div className="text-secondary text-[0.95rem] leading-relaxed space-y-4">
              <p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={label}
                  className="bg-surface border border-white/[0.07] rounded-xl p-5 hover:border-white/[0.15] transition-colors">
                  <div className="text-[2rem] font-bold tracking-[-0.04em] leading-none mb-1 text-primary">{num}</div>
                  <div className="text-[0.75rem] text-muted tracking-wide">{label}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <section id="education" className="py-20 border-t border-white/[0.07]">
          <h2 className="text-[1.6rem] font-semibold tracking-[-0.03em] mb-12">Education</h2>
          <div className="flex flex-col gap-2">
            {[
              ...
              <div key={school}
                className="grid grid-cols-[1fr_auto] items-start gap-4 px-6 py-5 bg-surface rounded-xl hover:bg-surface2 transition-colors">
                <div>
        ...
        <section id="experience" className="py-20 border-t border-white/[0.07]">
          <h2 className="text-[1.6rem] font-semibold tracking-[-0.03em] mb-12">Experience</h2>
          <div className="flex flex-col">
            {[
              ...
              <div key={title}
                className={`grid grid-cols-[120px_1fr] gap-8 py-7 ${i < arr.length - 1 ? 'border-b border-white/[0.07]' : ''} ${i === 0 ? 'pt-0' : ''}`}>
                <div className="text-[0.72rem] text-muted pt-[0.2rem]">{date}</div>
                <div>
        ...
        <section id="projects" className="py-20 border-t border-white/[0.07]">
          <h2 className="text-[1.6rem] font-semibold tracking-[-0.03em] mb-12">Projects</h2>
          <div className="grid grid-cols-2 gap-4">


            <div
              className="col-span-2 flex gap-6 p-7 rounded-2xl border border-white/[0.08] transition-all duration-300 hover:border-white/[0.16] hover:-translate-y-1 relative overflow-hidden"
              style={{
              ...
              <div className="flex-1">
                ...
                <div className="flex items-start justify-between mb-3">
                  ...
                  <a href="https://github.com/PrakashShukla0907/FocusShield" target="_blank" rel="noreferrer"
                    className="text-[0.72rem] border border-white/[0.07] px-[0.65rem] py-[0.3rem] rounded-md text-muted hover:text-primary hover:border-white/25 transition-all ml-4">
                    GitHub ↗
                  </a>
                </div>
            ...
            {[
              ...
              <div key={name}
                className="flex flex-col p-7 rounded-2xl border border-white/[0.08] transition-all duration-300 hover:border-white/[0.16] hover:-translate-y-1 overflow-hidden"
                style={{
                  background: 'rgba(255,255,255,0.03)',
                  backdropFilter: 'blur(12px)',
                  boxShadow: '0 2px 20px rgba(0,0,0,0.25), inset 0 1px 0 rgba(255,255,255,0.06)',
              ...
              >
                ...
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="flex gap-[0.4rem] ml-3">
                    {github && (
        ...
        <section id="skills" className="py-20 border-t border-white/[0.07]">
          <h2 className="text-[1.6rem] font-semibold tracking-[-0.03em] mb-12">Skills</h2>
          <div className="grid grid-cols-[repeat(auto-fill,minmax(300px,1fr))] gap-6">
            {[
              ...
              <div key={label}
                className="bg-[rgba(255,255,255,0.03)] border border-white/[0.08] rounded-2xl px-8 py-8 min-h-[160px] flex flex-col justify-center hover:border-white/[0.16] hover:-translate-y-1 transition-all duration-300"
                style={{
                  backdropFilter: 'blur(12px)',
                  boxShadow: '0 2px 20px rgba(0,0,0,0.25), inset 0 1px 0 rgba(255,255,255,0.06)',
                }}
      ...
      <div className="max-w-[860px] mx-auto px-10">
        <div id="contact" className="py-20 border-t border-white/[0.07] text-center">
          <h2 className="text-[clamp(2rem,5vw,3.5rem)] font-bold tracking-[-0.04em] mb-3">
          ...
          <div className="flex justify-center flex-wrap gap-3 mb-16">
            {[
              ...
              <a key={label} href={href} target={href.startsWith('http') ? '_blank' : undefined} rel="noreferrer"
                className="flex items-center gap-2 text-[0.8rem] border border-white/[0.07] px-[1.1rem] py-2 rounded-lg text-secondary hover:border-white/25 hover:text-primary hover:bg-surface transition-all">
                {label}
              </a>
            ))}
          </div>
          <div className="flex justify-between items-center text-[0.72rem] text-muted pt-6 border-t border-white/[0.07]">
